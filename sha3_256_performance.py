...
# NIM : 18220094
# File analisis performa SHA3 - 256
import hashlib
import psutil
import time

def calculate_performance_sha3_256(message, iterations=1000):
    ...
    for i in range(iterations):
        ...
        cpu_usage = max(end_cpu_usage - start_cpu_usage, 0)
...
calculate_performance_sha3_256(message)